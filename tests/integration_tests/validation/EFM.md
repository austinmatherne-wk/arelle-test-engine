...
#### Update Timing File
The previous run also generated `.test_engine/efm_current/timing.json`. Rename this to `efm_current.json` and relocate to `tests/resources/conformance_suites_timing/efm_current.json`
